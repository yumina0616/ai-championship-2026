...
2026-09-17 사용자 추가 요청으로 #13 실제 R2 수집과 #17의 export·정제·후보 비교 도구를 연결한다. 수집 선택은 한 번 받고 이후 다음 완료 주행부터 자동 전송한다. #17의 실제 데이터 재학습/승격은 데이터 축적 후 yumina0616 검토로 진행하며, 도구를 만들었다고 모델 개선/Issue 전체 완료로 표시하지 않는다.
