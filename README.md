...
공개 테스트: [Mr.Park 미스터팍](https://parkside-parking.jinhyeong9568-663.workers.dev). 기존 주소를 유지하며 브랜드와 선택형 수집을 반영했습니다. 새 방문자는 ‘미스터팍과 함께 배우기’에서 전송을 선택할 수 있습니다. 배포 설정·검증·남은 점은 [Cloudflare 배포 안내](docs/cloudflare-deployment.md)를 따릅니다. CI artifact 제공과 공개 배포는 별개입니다.
